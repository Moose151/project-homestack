...
export function FitnessPage() {
  ...
  return <div className="space-y-4"><PageHeader title="Fitness & training" subtitle="Programs, live workouts and household personal bests" icon="🏋️" />{error && <InlineAlert tone="danger">{error}</InlineAlert>}<Tabs tabs={TABS} active={tab} onChange={setTab} mobileSelectLabel="Fitness section" />
