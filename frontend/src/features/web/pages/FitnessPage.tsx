...
export function FitnessPage() {
  ...
  return <div className="space-y-4">{!inLiveSession && <PageHeader title="Fitness" subtitle="Programs, live workouts and household personal bests" icon="🏋️" />}{error && <InlineAlert tone="danger">{error}</InlineAlert>}{!inLiveSession && <Tabs tabs={TABS} active={tab} onChange={setTab} mobileSelectLabel="Fitness section" />}
