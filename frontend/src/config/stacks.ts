...
export const STACKS: StackDef[] = [
  ...
  { key: 'atlas', label: 'Lists & Notes', navLabel: 'Lists & Notes', shortLabel: 'Lists', description: 'Grocery, to-dos and notes', navGroup: 'organise', route: '/atlas', icon: '🗒', colour: '#5b57d1', isNode: true },
