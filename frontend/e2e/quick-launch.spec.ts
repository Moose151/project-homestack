...
const TARGETS = [
  { key: 'core.calendar', label: 'Calendar', description: 'Events, appointments and what is coming up', icon: '📅', node_key: '', target_type: 'open', requires_object: false, sensitive: false, launch_modes: ['normal', 'focused'], objects: [] },
