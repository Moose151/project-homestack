...
_MODELS = ['educationassessment', 'educationevent']
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="educationassessment", name="assigned_to_person"),
        migrations.RemoveField(model_name="educationevent", name="assigned_to_person"),
