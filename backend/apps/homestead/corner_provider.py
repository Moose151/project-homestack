...
def provide(*, user, person, since):
    ...
    assignments = [{
        ...
        "action_url": f"/homestead/rooms/{row.room_id}",
    ...
    activity = [{
        ...
        "occurred_at": row.completed_at.isoformat(), "action_url": f"/homestead/rooms/{row.room_id}",
    ...
    if person.linked_user_id:
        ...
        activity.extend({
            ...
            "action_url": f"/homestead/rooms/{row.plan_item.room_id}",
        } for row in products)
    collections = [{
