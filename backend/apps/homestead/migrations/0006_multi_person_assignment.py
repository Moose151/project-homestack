...
_MODELS = ['maintenancetask', 'improvement', 'roomplanitem']


def carry_assignees_forward(apps, schema_editor):
    for model_name in _MODELS:
        Model = apps.get_model("homestead", model_name)
...
class Migration(migrations.Migration):
    dependencies = [
        ("homestead", "0005_roomplanproduct"),
        ("people", "0001_initial"),
    ]
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="maintenancetask", name="assigned_to_person"),
        migrations.RemoveField(model_name="improvement", name="assigned_to_person"),
        migrations.RemoveField(model_name="roomplanitem", name="assigned_to_person"),
